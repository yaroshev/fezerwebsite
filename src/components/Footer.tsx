    ...
    <footer className="section-gradient py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-semibold text-white mb-4">Domum</h3>
            <p className="text-gray-400 mb-6">
              Crafting premium cabinetry and storage solutions for Victoria's finest homes.
            </p>
            <div className="space-y-3">
              <a href="tel:2506810228" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors duration-300">
                <Phone className="h-5 w-5" />
                <span>(250) 681-0228</span>
              </a>
              <a href="mailto:info@domumimpro.com" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                <span className="font-medium">Mon - Fri:</span> 8:00 AM - 5:00 PM
              </li>
              <li className="text-gray-400">
